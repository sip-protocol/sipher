...
// checks if the CommitmentCreateBatch200ResponseDataResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommitmentCreateBatch200ResponseDataResultsInner{}

// CommitmentCreateBatch200ResponseDataResultsInner struct for CommitmentCreateBatch200ResponseDataResultsInner
type CommitmentCreateBatch200ResponseDataResultsInner struct {
...
func NewCommitmentCreateBatch200ResponseDataResultsInner() *CommitmentCreateBatch200ResponseDataResultsInner {
	this := CommitmentCreateBatch200ResponseDataResultsInner{}
	return &this
}
...
func (o CommitmentCreateBatch200ResponseDataResultsInner) MarshalJSON() ([]byte, error) {
...
func (o CommitmentCreateBatch200ResponseDataResultsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCommitmentCreateBatch200ResponseDataResultsInner struct {
	value *CommitmentCreateBatch200ResponseDataResultsInner
	isSet bool
}

func (v NullableCommitmentCreateBatch200ResponseDataResultsInner) Get() *CommitmentCreateBatch200ResponseDataResultsInner {
	return v.value
}

func (v *NullableCommitmentCreateBatch200ResponseDataResultsInner) Set(val *CommitmentCreateBatch200ResponseDataResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitmentCreateBatch200ResponseDataResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitmentCreateBatch200ResponseDataResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitmentCreateBatch200ResponseDataResultsInner(val *CommitmentCreateBatch200ResponseDataResultsInner) *NullableCommitmentCreateBatch200ResponseDataResultsInner {
	return &NullableCommitmentCreateBatch200ResponseDataResultsInner{value: val, isSet: true}
}

func (v NullableCommitmentCreateBatch200ResponseDataResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommitmentCreateBatch200ResponseDataResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
